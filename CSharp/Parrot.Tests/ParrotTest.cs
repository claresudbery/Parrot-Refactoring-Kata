...
namespace Parrot.Tests
{
    public class ParrotTest
    {
        ...
        {
            var parrot = Parrot.CreateInstance(ParrotTypeEnum.NORWEGIAN_BLUE, 0, 0, true);
        ...
        {
            var parrot = Parrot.CreateInstance(ParrotTypeEnum.NORWEGIAN_BLUE, 0, 1.5, false);
        ...
        {
            var parrot = Parrot.CreateInstance(ParrotTypeEnum.NORWEGIAN_BLUE, 0, 4, false);
        ...
        {
            var parrot = Parrot.CreateInstance(ParrotTypeEnum.NORWEGIAN_BLUE, 0, 0, false);

...
namespace Parrot.Tests
{
    public class ParrotTest
    {
        ...
        {
            var parrot = Parrot.CreateInstance((ParrotTypeEnum)ParrotTypeEnum.NorwegianBlue, (int)0, (double)0, (bool)true);
        ...
        {
            var parrot = Parrot.CreateInstance((ParrotTypeEnum)ParrotTypeEnum.NorwegianBlue, (int)0, (double)1.5, (bool)false);
        ...
        {
            var parrot = Parrot.CreateInstance((ParrotTypeEnum)ParrotTypeEnum.NorwegianBlue, (int)0, (double)4, (bool)false);
